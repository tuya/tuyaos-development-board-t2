 ...
 * @return OPRT_OK on success. Others on error, please refer to tuya_error_code.h
 */
OPERATE_RET mqc_upgd_progress_rept_v41(IN CONST UINT_T percent, IN CONST CHAR_T *devid, IN CONST DEV_TYPE_T tp, IN CONST UINT_T remain_time);
 ...
 * @brief Set customized linakge for mqtt connection
 *
 * @param[in] is_auto TRUE-close live mqtt connection and reconnect when linkage switch
 *
