...
typedef struct mqtt_config {
    ...
    */
    char*           url;/*带有scheme的mqtt url,比如:mqtts://iot.com; wss://iot.com*/
    int             port;   //mqtt boker port
    ...
    bool      enable_tls;
} mqtt_config_t, *p_mqtt_config_t;
/**
* @brief 创建mqtt client handle
*
* @param[in] mqtt_config: mqtt配置，详见mqtt_config_t定义
* @param[out] hand: 创建的mqtt handle
*
* @note: 作用同create_mqtt_hand，精简汇聚了mqtt的参数到mqtt_config_t
*
...
* @param[in] mqtt_config: mqtt配置，详见mqtt_config_t定义
*
* @note: mqtt连接断开后，可能会更新mqtt的uri，此时需要重新设置uri
*
* @return OPERATE_RET: OPRT_OK成功，其它请参照tuya error code描述文档
*/
