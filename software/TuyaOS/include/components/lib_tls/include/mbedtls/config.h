...
#if defined(TUYA_CAT1) && (TUYA_CAT1==1) && (OPERATING_SYSTEM < SYSTEM_LINUX)
#define unix
#include "tuya_tls_config_ecc_psk_cat1.h"
#elif defined(TUYA_NB) && (TUYA_NB==1)
//#include "tuya_tls_config_ecc_psk_nb.h"
#include "tuya_tls_config_psk_only_nb.h"
#else
