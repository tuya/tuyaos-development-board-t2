 ...
 * @retval -1 On IO error.
 */
int mqtt_subscribe_ext(mqtt_broker_handle_t* broker, const char* topics[], uint8_t cnt, uint16_t* message_id);
 ...
 * @retval -1 On IO error.
 */
int mqtt_unsubscribe_ext(mqtt_broker_handle_t* broker, const char* topics[], uint8_t cnt, uint16_t* message_id);
